...
import type { ResumeCustomSection, ResumeCustomSectionMode } from '../types/resume';
...
export type StandardSectionKey = (typeof sectionOrder)[number];
...
export const sectionDefinitions: Record<StandardSectionKey, SectionDefinition> = {
  socials: {
    title: '社交与链接',
